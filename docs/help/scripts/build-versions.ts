 ...
 * fork supersedes it. It also generates `.vitepress/sidebars/generated.ts`,
...
const { sidebar } = await import(
  pathToFileURL(join(HELP, ".vitepress", "sidebar.ts")).href
);
...
writeFileSync(
  join(SIDEBARS, "generated.ts"),
  [
    "// Generated by scripts/build-versions.ts — do not edit, do not commit.",

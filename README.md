...
./Openotes-2.1.0-linux-x86_64.AppImage

# Debian / Ubuntu
sudo apt install ./Openotes-2.1.0-linux-x86_64.deb

# Fedora / RHEL
sudo dnf install ./Openotes-2.1.0-linux-x86_64.rpm

# Arch / Manjaro
sudo pacman -U openotes-2.1.0-1-x86_64.pkg.tar.zst

# Flatpak
flatpak install Openotes-2.1.0-linux-x86_64.flatpak
```
